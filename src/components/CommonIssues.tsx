...
const CommonIssues = () => {
  ...
  return <section id="issues" className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="mt-12 text-center">
          <div className="bg-centra-blue rounded-xl p-6 md:p-10 text-white max-w-4xl mx-auto">
            ...
            <Button size="lg" className="bg-whatsapp-green hover:bg-whatsapp-green/90 text-white font-semibold px-6 py-2 w-auto" onClick={() => window.open(whatsappLink, "_blank")}>
