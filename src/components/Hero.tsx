  ...
  return (
    <section className="relative mt-16 md:mt-20 bg-centra-blue text-white py-16 md:py-24 overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1679501072696-9e7c538d71f9?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
